...
const Feedback = () => {
    return (
        <div className="relative h-full">
            ...
            <Swiper
                slidesPerView={window.screen.width < '640' ? 1 : 3}
                spaceBetween={1}
                freeMode={true}
                pagination={{
                    clickable: true,
            ...
            >
                ...
                <SwiperSlide className="h-40 w-20 shadow-md ml-10 mr-10 mb-16">
                    <div className="flex flex-col justify-center items-center pb-6 rounded">
                        <img className="mt-10 mb-5 h-20 w-20 rounded-full" src="https://cdn.pixabay.com/photo/2014/07/09/10/04/man-388104_960_720.jpg" alt="" />
                        <h1 className="text-xl text-red-400">Andrew Watt</h1>

                        <ul class="flex justify-center mb-7 mt-7">
                            <li>
                        ...
                        <p className="text-gray-400 opacity-70 text-center pl-10 pr-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam iusto voluptate consequatur praesentium temporibus ipsam minus explicabo neque eum culpa?</p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="h-40 w-20 shadow-md ml-10 mr-10 mb-16 overflow-x-auto">
                    <div className="flex flex-col justify-center items-center pb-6 rounded">
                        <img className="mt-10 mb-5 h-20 w-20 rounded-full" src="https://cdn.pixabay.com/photo/2014/07/09/10/04/man-388104_960_720.jpg" alt="" />
                        <h1 className="text-xl text-red-400">Andrew Watt</h1>
